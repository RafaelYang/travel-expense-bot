...
test("statistics expose a scoped fee and reward analysis without merging it into categories", () => {
  ...
  assert.match(statsModalSource, /statistics\.adjustmentSummary\.serviceFee/u)
  assert.match(statsModalSource, /statistics\.adjustmentSummary\.shopbackReward/u)
  assert.match(statsModalSource, /statistics\.adjustmentSummary\.creditCardReward/u)
